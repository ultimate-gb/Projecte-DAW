...
@section('mainContent')
    ...
    <form action="{{route('register.save')}}" method="post">
        ...
        <div class="input-group mb-4">
            <label class="input-group-text d-flex justify-content-center {{ $labelClassCols }}" for="emailInput"><i class="fas fa-at"></i></label>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text d-flex justify-content-center  {{ $labelClassCols }}" for="nomInput">Nom</label>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text d-flex justify-content-center  {{ $labelClassCols }}" for="cognom1Input">Primer Cognom</label>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text d-flex justify-content-center  {{ $labelClassCols }}" for="cognom2Input">Segon Cognom</label>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text d-flex justify-content-center  {{ $labelClassCols }}" for="passInput"><i class="fas fa-key"></i></label>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text d-flex justify-content-center  {{ $labelClassCols }}" for="dataNaixInput">Data Naixement</label>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text d-flex justify-content-center {{ $labelClassCols }}" for="telefonInput">Telefon</label>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text {{ $labelClassCols }}" for="genereSel">Genere</label>
          ...
          <div class="input-group mb-3">
            <label class="input-group-text {{ $labelClassCols }}" for="nacionalitatSel">Nacionalitat</label>
            <select class="form-select {{ $inputClassCols }}" id="nacionalitatSel">
